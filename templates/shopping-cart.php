 ...
 * 
 * @link  custom-add-to-cart-ajax.js
 * @see rvbs-add-to-cart.php
 */
...
<body <?php body_class(); ?>>
    ...
    <div class="container">
        <h1>Shopping Cart</h1>
        <p class="cart-count-text"><?php echo count($cart); ?> Sites</p>
            ...
            <div class="cart-wrapper">
                <div class="cart-items">
                    ...
                    foreach ($cart as $item) : 
                        ...
                        $cart_total += $subtotal;
                    ?>
                    <div class="cart-item" data-id="<?php echo esc_attr($post_id); ?>">
