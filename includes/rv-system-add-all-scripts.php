...
{
	// load primary css 
	wp_enqueue_style('rv_booking_system_bootstrap', plugin_dir_url(__FILE__) . '/public/css/bootstrap.min.css', array(), RV_BOOKING_SYSTEM_VERSION, 'all');
	wp_enqueue_style(
		'ecommarcetheam-icon',
		'https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css',
		array(),
		RV_BOOKING_SYSTEM_VERSION,
		'all'
	);
	// enque bootstrap css 
}
